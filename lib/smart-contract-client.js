...
import { RPC_URL, RPC_AUTH, CONTRACT_ADDRESS } from './constants.js'
 ...
 * @param {function} [options.smartContract] - Function to get the smart contract client
...
export async function getMinerPeerIdFromSmartContract (
  ...
  try {
    const contractClient = smartContract ?? (await getSmartContractClient(RPC_URL))
