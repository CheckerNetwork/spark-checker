...
export default class Spark {
  ...
  async executeRetrievalCheck(retrieval, stats) {
    ...
    if (noValidAdvertisement) {
      ...
      return await this.checkRetrievalFromAlternativeProvider(alternativeProviders, retrieval.cid, stats)
    }
  ...
  async checkRetrievalFromAlternativeProvider(providers, cid, stats) {
    if (!providers.length) {
