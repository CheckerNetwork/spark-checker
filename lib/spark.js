...
import { SPARK_VERSION, MAX_CAR_SIZE, APPROX_ROUND_LENGTH_IN_MS, MAX_REQUEST_DURATION_MS } from './constants.js'
...
export default class Spark {
  ...
  async fetchCAR (protocol, address, cid, stats, { maxFetchDurationMs = MAX_REQUEST_DURATION_MS } = {}) {
